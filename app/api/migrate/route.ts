...
export async function POST(req: Request) {
  ...
  // 0013: tabla montajes (modulo independiente cortar-silencios → MP4 final
  // montado). Importado del branch montaje en el merge — se renumero de 0005
  // a 0013 porque el numero original colisionaba con 0005_capcut_url que ya
  // estaba aplicada en produccion. El archivo .sql tambien quedo como
  // 0013_montajes.sql.
  await runMigration("0013_montajes", async () => {
    await sql`
